...
import { Container, Row, Col, Grid, Badge } from 'rsuite'
  ...
  return (
    <HotKeys keyMap={keyMap} handlers={handlers}>
      <Modal
        ...
        size='md'
        show={showHelpModal}
        onHide={() => setHelpModal(!showHelpModal)}
          ...
          <Container className='keyboard-shortcut-container'>
            ...
            window.location.pathname === '/settings' ? (
              <Row className='keyboard-row'>
                <Col>
                  <Badge className='key-badge' outline theme='primary'>
                    ALT
                  </Badge>{' '}
