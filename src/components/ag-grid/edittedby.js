  ...
  return (
    <>
      ...
      <span className='user-pic-wrapper' style={loadingStyle}>
        <img className='user-pic' style={{ border: '2px solid #67B246', borderRadius: '50%' }} src={`/static/images/avatars/${avatarFile}`} width='32px' height='32px' onLoad={(() => setLoading(false))} />
      </span>
    </>
  )
}
