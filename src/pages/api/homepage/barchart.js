...
module.exports = async (req, res) => {
  const peopleQuery = await db.query(escape`
    select WEEK(maintenancedb.maileingang) as 'week', YEAR(maintenancedb.maileingang) as 'year',  maintenancedb.bearbeitetvon as 'user', count(maintenancedb.id) as 'count'
      from maintenancedb
